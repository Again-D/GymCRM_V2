...
class MembershipHoldAutoResumeSchedulerTest {
    ...
    void resumesExpiredHoldsAndEnqueuesCrmEvent() {
        ...
        Member member = new Member(
                ...
                null, null, LocalDate.now().minusDays(100), true, false, null, null, null, OffsetDateTime.now(), 1L, OffsetDateTime.now(), 1L
        );
    ...
    void catchesUpOverdueHoldsWhenPreviousRunWasMissed() {
        ...
        Member member = new Member(
                ...
                null, null, LocalDate.now().minusDays(120), true, false, null, null, null, OffsetDateTime.now(), 1L, OffsetDateTime.now(), 1L
        );
        MembershipHold resumedHold = new MembershipHold(
                78L,
                1L,
