...
| 시스템 | roles | 역할 (SUPER_ADMIN, MANAGER, TRAINER, STAFF) |
...
| role_name | VARCHAR(50) | O | - | 역할명 (SUPER_ADMIN, MANAGER, TRAINER, STAFF) |
...
(2, 'MANAGER', '센터 매니저', CURRENT_TIMESTAMP, 1, CURRENT_TIMESTAMP, 1),
